...
public class FeaturePackDescriptionXMLWriter10 {
    ...
    public void write(FeaturePackDescription featurePackDescription, File outputFile) throws XMLStreamException, IOException {
        ...
        ArtifactRefsXMLWriter10.INSTANCE.write(featurePackDescription.getArtifactRefs(), featurePackElementNode);
    ...
    protected void processDependencies(List<String> dependencies, ElementNode featurePackElementNode) {
        if (!dependencies.isEmpty()) {
            ...
            for (String artifactName : dependencies) {
                final ElementNode artifactElementNode = new ElementNode(dependenciesElementNode, Element.FEATURE_PACK.getLocalName());
                artifactElementNode.addAttribute(Attribute.ARTIFACT.getLocalName(), new AttributeValue(artifactName));
