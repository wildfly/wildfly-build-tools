...
import org.wildfly.build.forge.resource.VersionOverrideResource;

/**
 * @author Eduardo Martins
 */
public class VersionOverrideRemoveCommand extends ServerProvisioningDescriptionChildResourceRemoveCommand {
    ...
    @Override
    protected Iterable<? extends VersionOverrideResource> getResourceValueChoices(ServerProvisioningDescriptionResource descriptionResource) {
        return descriptionResource.getVersionOverrides();
    }
