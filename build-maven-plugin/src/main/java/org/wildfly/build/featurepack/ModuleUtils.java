...
/**
 * Utility class to find all module directories in a distribution.
 *
...
public class ModuleUtils {
    ...
    public static Map<ModuleIdentifier, ModuleParseResult> enumerateModuleDirectory(Logger log, final Path moduleDirectory) throws IOException {
    ...
    private static final class ModuleVisitor implements FileVisitor<Path> {
        ...
        private ModuleVisitor(Path moduleRoot, Logger log) {
